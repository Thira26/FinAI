...
import com.example.finai.ui.StreaksFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.bottomNav.setOnItemSelectedListener(item -> {
            ...
            if (id == R.id.menu_home) {
                ...
                return true;
            } else if (id == R.id.menu_streaks) {
                getSupportFragmentManager().beginTransaction()
                        .replace(R.id.nav_host_fragment, new StreaksFragment())
                        .commit();
                if (binding.toolbar != null) binding.toolbar.setTitle("Savings Streaks");
                return true;
            }
            return false;
        });
    ...
    private void maybeShowOnboarding() {
        ...
        if (!seen) {
            new AlertDialog.Builder(this)
                    ...
                    .setMessage("• Home shows your summary and trends\n• Analytics visualizes spends\n• Streaks tracks your savings progress with rewards\n\nTip: Stay within your budget to build streaks!")
