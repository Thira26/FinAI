...
public class HomeFragment extends Fragment {
    ...
    private boolean isTransactionsExpanded = true;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.btnAddGoal.setOnClickListener(v -> {
            ...
            nav.setSelectedItemId(R.id.menu_streaks);
        });
        ...
        setupTransactionsExpandCollapse();
    ...
    private void setupTransactionsExpandCollapse() {
        binding.transactionsHeader.setOnClickListener(v -> {
            // Animate arrow rotation
            // When expanded: arrow points down (0°), when collapsed: arrow points right (-90°)
            ImageView arrow = binding.transactionsArrow;
            float fromDegree = isTransactionsExpanded ? 0f : -90f;
            float toDegree = isTransactionsExpanded ? -90f : 0f;
            ...
            binding.transactionsList.setVisibility(isTransactionsExpanded ? View.VISIBLE : View.GONE);
        });
    }
